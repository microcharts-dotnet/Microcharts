            ...
            if (total > 0)
            {
                ...
                using (var clip = new SKPath())
                {
                    ...
                    for (int i = 0; i < total; i++)
                    {
                        ...
                        canvas.DrawCaptionLabels(entry.Label, entry.TextColor, RightToLeftMode, entry.ValueLabel, entry.Color.WithAlpha((byte)(255 * AnimationProgress)), LabelTextSize, labelPoint, alignment, base.Typeface, out var _);
                    }
                }
            }
        }
