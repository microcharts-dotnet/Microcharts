...
namespace Microcharts
{
    ...
    /// A grouped bar chart.
    /// </summary>
    public class BarSeriesChart : SeriesChart, IBarChart
    {
        #region Constructors
        ...
        private void OnLabelOrientationChanged()
        {
            //if (IsSeriesAutoGenerated && ValueLabelOrientation == Orientation.Default)
            //    ValueLabelOrientation = LabelOrientation;
        }
        ...
        public GroupedBarLegendOption LegendOption { get; set; } = GroupedBarLegendOption.None;
        ...
        public override void DrawContent(SKCanvas canvas, int width, int height)
        {
            if (Series != null && entries != null)
            {
                ...
                var headerHeight = MeasureHelper.CalculateFooterHeaderHeight(Margin, ValueLabelTextSize, valueLabelSizes.Values.ToArray(), ValueLabelOrientation);
                ...
                for (int i = 0; i < labels.Length; i++)
                {
                    ...
                    for (int serieIndex = 0; serieIndex < nbSeries; serieIndex++)
                    {
                        ...
                        DrawBarArea(canvas, headerWithLegendHeight, itemSize, barSize, serie.Color ?? entry.Color, value, barX, barY);
                        DrawBar(canvas, headerWithLegendHeight, itemSize, barSize, origin, barX, barY, serie.Color ?? entry.Color);
