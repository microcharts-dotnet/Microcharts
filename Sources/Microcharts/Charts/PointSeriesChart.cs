...
namespace Microcharts
{
    ...
    /// A grouped bar chart.
    /// </summary>
    public class PointSeriesChart : AxisBasedChart
    {
        #region Constructors
        ...
        protected Dictionary<ChartSerie, List<SKPoint>> pointsPerSerie = new Dictionary<ChartSerie, List<SKPoint>>();
